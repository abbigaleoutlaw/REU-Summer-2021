...
I have also normalized the number of times a Hispanic voter has voter by zip code and by age in the Voter Activity-Nassau file. Dr. Berezovski is helping me work with the normalization, so that I will be able to draw conclusions from the normalized data.
